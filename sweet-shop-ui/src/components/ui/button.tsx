...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    ...
    const variants = {
      ...
      // In variants object, add:
      luxury: "bg-gradient-gold text-black hover:shadow-lux border-gold font-serif uppercase tracking-widest",
// And update default to include font-serif where needed.
    }
