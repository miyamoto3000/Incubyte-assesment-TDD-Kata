...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-slate-900 to-black p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-lg relative bg-gradient-to-br from-gray-800/60 via-gray-900/70 to-black/60 backdrop-blur-xl border border-crimson/20 shadow-2xl shadow-crimson/10 ring-1 ring-crimson/10 overflow-hidden">
        ...
        <CardContent className="pt-0 relative z-10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="relative group">
              ...
              />
              {errors.username && <span className="text-xs text-red-400/90 font-mono block mt-2 pl-1">Access credentials required</span>}
            </div>
            ...
            <div className="relative group">
              ...
              />
              {errors.password && <span className="text-xs text-red-400/90 font-mono block mt-2 pl-1">Secure passage required</span>}
            </div>
